  ...
  return (
    <section className="mt-8">
      <div className="relative">
        ...
        {/* 그라데이션 + 버튼 (더 보기) */}
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-white dark:from-neutral-900 via-white/20 dark:via-neutral-900/80 to-transparent flex items-end justify-center">
          <button
            type="button"
