import type { CoverflowCardContentProps } from "../../model/CoverflowCardContent/types";


export function CoverflowCardContent({ title, description, badge }: CoverflowCardContentProps) {
  return (
