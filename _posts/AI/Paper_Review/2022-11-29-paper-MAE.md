...
![Desktop View](/static/img/Paper_Review/MAE/architecture.png)
_MAE Architecture_
...
![Desktop View](/static/img/Paper_Review/MAE/masking-ratio.png)
_Masking ratio 별 validation 정확도 비교: Fine-tuning model에 대한 결과(상)와 Linear probing에 대한 결과(하)_
![Desktop View](/static/img/Paper_Review/MAE/masking-result.png)
...
|:-:|:-:|:-:|
|![](/static/img/Paper_Review/MAE/ft-lin1.png)|![](/static/img/Paper_Review/MAE/ft-lin2.png)|![](/static/img/Paper_Review/MAE/ft-lin3.png)|

|Reconstruction target|Data augmentation|Mask sampling|
|:-:|:-:|:-:|
|![](/static/img/Paper_Review/MAE/ft-lin4.png)|![](/static/img/Paper_Review/MAE/ft-lin5.png)|![](/static/img/Paper_Review/MAE/ft-lin6.png)|

|Masking 방법|Epochs에 따른 Accuracy|
|:-:|:-:|
|![](/static/img/Paper_Review/MAE/masking-strategy.png)|![](/static/img/Paper_Review/MAE/training-schedules.png)|
...
|![](/static/img/Paper_Review/MAE/vs-self-supervised.png)|![](/static/img/Paper_Review/MAE/vs-supervised.png)|![](/static/img/Paper_Review/MAE/partial-fine-tuning.png)|
|:-:|:-:|:-:|
|MAE vs Self-supervised pretrained models|MAE vs Supervised pretrained models|Partial fine-tuning|

|![](/static/img/Paper_Review/MAE/object-detection-segmentation.png)|![](/static/img/Paper_Review/MAE/semantic-segmentation.png)|
|:-:|:-:|
|Object detection and segmentation|Semantic segmentation|

|![](/static/img/Paper_Review/MAE/comparison-with-dataset.png)|![](/static/img/Paper_Review/MAE/pixel-vs-token.png)|
|:-:|:-:|
|Object detection and segmentation|Semantic segmentation|
